...
const mostBlogs = (blogs) => {
  ...
  const maxAuthor = ld.maxBy(Object.keys(authorCounts), (author) => authorCounts[author])
...
const mostLikes = (blogs) => {
  ...
  const likesCountListSortedByAuthor = Object.entries(authors).map(([author, blogs]) => ({
    author,
